...
def get_ndcg_diffs(smt_run_dir, other_run_dir):
    ndcg_diffs = []
    ...
    for qrel, run_name in [(trec_19_rel, "TREC_DL_2019"), (trec_20_rel, "TREC_DL_2020")]:
        ...
        with open(os.path.join(smt_run_dir, f"{run_name}/run.json")) as fin:
...
if __name__ == "__main__":
    ...
    smt_run_path = "./data/experiments-full-lexical-ripor/ripor_direct_lng_knp_seq2seq_1/sub_tokenid_8_out_100/MSMARCO/run.json"
    ...
    smt_run_dir = "./data/experiments-full-lexical-ripor/ripor_direct_lng_knp_seq2seq_1/sub_tokenid_8_out_100/"
    ...
    # for TREC'19 and 20
    ndcg_diffs = get_ndcg_diffs(smt_run_dir, other_run_dir)
    ...
    plt.tight_layout()
    plt.savefig("./t5_pretrainer/analysis/images/mrr_ndcg_diff_bar_plots_smt_joint_comp.jpg")