...
if __name__ == "__main__":
    bow_run_path = "./data/experiments-full-lexical-ripor/t5-full-dense-1-5e-4-12l/out/MSMARCO/run.json"
    ripor_run_path = "./data/experiments-splade/t5-splade-0-12l/out/MSMARCO/run.json"
    qrel_path = "./data/msmarco-full/dev_qrel.json"
