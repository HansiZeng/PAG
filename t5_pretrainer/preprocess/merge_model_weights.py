...
def get_args():
    ...
    parser.add_argument("--model_dir", 
                        default="./experiments-dense/t5-dense-1",
                        type=str)
    parser.add_argument("--other_model_dir",
                        default="./experiments-term-encoder/t5-term-encoder-0/",
                        type=str)
...
if __name__ == "__main__":
    args = get_args()
    pretrained_path = os.path.join(args.model_dir, "extended_token_checkpoint")
    ...
    out_dir = os.path.join(args.model_dir, "merged_extended_token_checkpoint")
